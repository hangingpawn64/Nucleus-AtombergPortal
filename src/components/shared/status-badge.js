...
export function StatusBadge({ status }) {
  ...
  switch (normalizedStatus) {
    ...
    case "not_started":
      return <Badge variant="outline" className="bg-slate-100 text-slate-700 hover:bg-slate-100/80 border-slate-200">Not Started</Badge>;
    case "submitted":
    ...
    case "active":
      return <Badge variant="outline" className="bg-green-100 text-green-700 hover:bg-green-100/80 border-green-200">Active</Badge>;
    case "completed":
      return <Badge variant="outline" className="bg-green-100 text-green-700 hover:bg-green-100/80 border-green-200">Completed</Badge>;
    case "on_track":
